...
class _MyChartState extends State<MyChart> {
    ...
    return BarChartData(
      titlesData: FlTitlesData(
        ...
        bottomTitles: AxisTitles(
          sideTitles: SideTitles(showTitles: true, reservedSize: 38, getTitlesWidget: bottomTitle)
        ),
        leftTitles: AxisTitles(
          sideTitles: SideTitles(showTitles: true, reservedSize: 38, getTitlesWidget: leftTitle)
        ),
      ),
  ...
  Widget leftTitle(double value, TitleMeta meta){
    ...
    return SideTitleWidget(child: Text(text, style: style,), axisSide: meta.axisSide, space: 0,);
  }
